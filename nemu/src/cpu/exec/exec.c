...
opcode_entry opcode_table [512] = {
  ...
  /* 0x04 */	EMPTY, IDEXW(E,push,1), IDEXW(E,pop,1), EMPTY,
  ...
  /* 0x28 */	IDEXW(E2G, sub, 1), IDEXW(E2G, sub, 1), IDEXW(G2E, sub, 1), IDEXW(G2E, sub, 1),
  ...
  /* 0xe8 */	IDEXW(I, call, 1), EMPTY, EMPTY, EMPTY,
