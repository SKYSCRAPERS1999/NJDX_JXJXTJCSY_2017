...
opcode_entry opcode_table [512] = {
  ...
  /* 0x1:q */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0x1c */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0x20 */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0x24 */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0x28 */	IDEXW(E2G, sub, 1), IDEX(E2G, sub), IDEXW(G2E, sub, 1), IDEX(G2E, sub),
  /* 0x2c */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0x30 */	IDEXW(E2G, xor, 1), IDEX(E2G, xor), IDEXW(G2E, xor, 1), IDEX(G2E, xor),
  /* 0x34 */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0x38 */	EMPTY, IDEX(G2E, cmp), EMPTY, IDEX(G2E, cmp),
  ...
  /* 0x84 */	IDEXW(G2E, test, 1), IDEXW(G2E, test, 4), EMPTY, EMPTY,
  ...
  /* 0xb4 */	EMPTY, EMPTY, IDEXW(mov_G2E, movzx, 2), IDEXW(mov_G2E, movzx, 2),
